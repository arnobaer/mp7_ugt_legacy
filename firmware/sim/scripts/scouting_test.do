...
vcom -93 -work work $GT_SRC/gt_mp7_core/frame/rb/rb_pkg_sim.vhd
vcom -93 -work work $GT_SRC/gt_mp7_core/frame/tcm/tcm_sim.vhd
vcom -93 -work work $GT_SRC/gt_mp7_core/frame/output_mux/mux_sim.vhd
vcom -93 -work work $GT_SRC/gt_mp7_core/frame/output_mux/output_mux_sim.vhd

#Testbench
vcom -93 -work work $TESTBENCH/scouting_test_tb.vhd

#Load Design
vsim -t 1ps work.scouting_test_tb 

##Load signals in wave window
view wave
do $TESTBENCH/../scripts/scouting_test_wave.do
